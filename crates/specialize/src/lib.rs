...
//! inside `hir-ty`: type inference owns evidence production, while later backend
//! stages such as Hull need an evidence-free, monomorphic IR.  Keeping the pass
//! in its own crate lets consumers depend on the monomorphic surface without
//! adding backend concerns to type checking.
//!
